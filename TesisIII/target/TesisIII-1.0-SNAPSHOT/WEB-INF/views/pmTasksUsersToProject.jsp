   ...
   <style>
    ...
    <body>
        ...
        <div>
            ...
            <br/>
            <c:choose>
            <c:when test="${(fn:length(tasksListByUserInProject) >= 1)}">
            <div style ="width:1000px; float: left; height:100px;  margin: 5px">
                ...
                <table style = "margin-left:auto; margin-right:auto; alignment-adjust:central;">
                        ...
                        <c:forEach items="${requestScope.tasksListByUserInProject}" var="t">
                            <tr>
                                <td>${t.title}</td>
                                <td>${t.description}</td>
                                <td>${t.deadLine}</td>
                                <td>${t.status}</td>
                                <td>
                                    <form:form method="get" action="http://localhost:90/TesisIII/pm/${login}/pmEditTask">
                ...
                <c:otherwise>
                    <div style ="width:1000px; float: left; height:100px;  margin: 5px">
                    <h3> No project task assigned yet to this user </h3>
                    </div>
                </c:otherwise> 
            </c:choose>
        </div>
